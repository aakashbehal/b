	...
	render() {
		return(
			...
			<View style={styles.container}>
				<Text style={{color:'white', fontSize:26, marginTop:150, fontWeight:'bold'}}>Track Payments & Get</Text>
				<Text style={{color:'white', fontSize:26,  fontWeight:'bold'}}>Notifications</Text>
