	...
	render() {
		return(
			...
			<View style={styles.container}>
				<Text style={{color:'white', fontSize:26, marginTop:150, fontWeight:'bold'}}>Easily Manage </Text>
				<Text style={{color:'white', fontSize:26, fontWeight:'bold'}}>Appointments and Services </Text>
                ...
                <TouchableOpacity onPress={this.tutorial3} style={styles.button}>
